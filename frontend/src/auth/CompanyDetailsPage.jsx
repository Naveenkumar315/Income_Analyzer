...
const CompanyDetailsPage = ({ onClose, onSubmit, userEmail }) => {
  ...
  const handleFinish = useCallback(
    async (values) => {
      try {
        setLoading(true);
        console.log("Company / Individual details:", {
          tab: activeTab,
          values,
        });
        ...
        if (activeTab === "company") {
          ...
          signupData.companyInfo = {
            ...
            companyPhone: values.companyPhone.replace(/\D/g, ""),
          ...
          signupData.primaryContact = {
            ...
            phone: values.primaryPhone.replace(/\D/g, ""),
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 mb-6">
                  <FormField
                    ...
                    rules={nameValidation("Company Name")}
                  />
                  <FormField
                    type="dropdown"
                    label={
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 mb-6">
                  ...
                  <FormField
                    ...
                    onChange={(e) => {
                      ...
                      form.setFieldsValue({ zipCode: digitsOnly });

                      // keep your existing zip lookup
                      if (digitsOnly.length === 5) {
                        debouncedFetchLocation(digitsOnly);
                      }
                    }}
                  />
                ...
                >
                  ...
                  <div className="py-12 text-center">
                    <div className="mb-3">
                      <UploadOutlined
                        style={{ fontSize: "40px", color: "#22B4E6" }}
                      />
                    </div>
                    <p className="text-sm font-creato mb-1">
                      <span className="text-[#22B4E6] font-medium">
                        Upload a file
                      </span>
                    ...
                    {fileList.map((file, index) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <FileTextOutlined
                            style={{ fontSize: "24px", color: "#22B4E6" }}
                          />
                          <div>
