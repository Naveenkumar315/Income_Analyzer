            ...
            <div className="relative z-10 bg-white rounded-xl shadow-md w-[90%] max-w-[420px] md:w-[384px] md:h-[500px] px-6 py-6 md:px-8 md:py-8">
                ...
                >
                    ...
                    <div className="mt-2 text-[12px] leading-[16px] font-creato">
                        <span className={pwdChecks.lowercase ? "text-[#119d0c]" : "text-red-600"}>
                            At least one lowercase
                        </span>
                        {", "}

                        <span className={pwdChecks.uppercase ? "text-[#119d0c]" : "text-red-600"}>
                            one uppercase
                        </span>
                        {", "}

                        <span className={pwdChecks.number ? "text-[#119d0c]" : "text-red-600"}>
                            one number
                        </span>
                        {","}
                        <br />

                        <span className={pwdChecks.special ? "text-[#119d0c]" : "text-red-600"}>
                            one special character – [!@#$%^&*(),.?":{ }|]
                        </span>
                        {", "}

                        <span className={pwdChecks.length ? "text-[#119d0c]" : "text-red-600"}>
                            Minimum 12 characters
                        </span>
                        </div>
